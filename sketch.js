// Include MidiWriter library
// Make sure to add this script to your HTML file before the sketch script
// <script src="https://cdn.jsdelivr.net/npm/midi-writer-js@1.3.6/dist/MidiWriter.min.js"></script>
...
function setup() {
  createCanvas(900, squareSize * 13); // Adjust canvas width to accommodate both rows and space in between
